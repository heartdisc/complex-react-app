    ...
    <>
      <div className="search-overlay-top shadow-sm">
        <div className="container container--narrow">
          ...
          <input onChange={handlerInput} autoFocus type="text" autoComplete="off" id="live-search-field" className="live-search-field" placeholder="What are you interested in?" />
            ...
            {Boolean(state.results.length) && (
              <div className="list-group shadow-sm">
                ...
                {state.results.map(post => {
                  return <PostItem post={post} onClick={() => appDispatch({ type: "closeSearch" })} />;
                })}
              </div>
            )}
